...
export function Form1701({ data }: { data: FilingPdfData }) {
  ...
  return (
    <Document>
      <Page size="A4" style={sharedStyles.page}>
        <Text style={sharedStyles.title}>BIR Form 1701</Text>
        <Text style={sharedStyles.subtitle}>
          Annual Income Tax Return (Mixed-Income) · {data.taxYear.year}
        </Text>
        ...
        <View style={sharedStyles.section}>
          ...
          <View style={sharedStyles.twoCol}>
            ...
            <View style={sharedStyles.col}>
              <Text><Text style={sharedStyles.label}>Income Type: </Text>Mixed Income</Text>
        ...
        <Text style={sharedStyles.disclaimer}>
          System-generated BIR filing preview for mixed-income earners. Validate against official BIR eBIRForms/eFPS before submission.
        </Text>
      </Page>
    </Document>
  )
