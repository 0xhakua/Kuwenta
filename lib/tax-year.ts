 ...
 *
 * - 8 returns if COR includes 2551Q (4 × 2551Q + 3 × 1701Q + 1701A)
 * - 4 returns if COR does not include 2551Q (3 × 1701Q + 1701A)
 */
export async function initializeTaxYear(
  ...
  const dueDates = getDueDatesForYear(year, corIncludes2551Q, holidays)
  const returns: Array<{
    ...
    ? [
        ...
        { formType: 'FORM_1701A' as const, quarter: null, sequenceOrder: 8 },
      ]
    : [
        ...
        { formType: 'FORM_1701A' as const, quarter: null, sequenceOrder: 4 },
      ]
